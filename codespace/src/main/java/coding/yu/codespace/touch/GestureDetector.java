...
public class GestureDetector {
    ...
    private static int FLAG_IS_GENERATED_GESTURE = 0x8;

    /**
     * The listener that is used to notify when gestures occur.
     * If you want to listen for all the different gestures then implement
     * this interface. If you only want to listen for a subset it might
     * be easier to extend {@link android.view.GestureDetector.SimpleOnGestureListener}.
     */
    public interface OnGestureListener {
        ...
        boolean onScrollFinish(MotionEvent e);
    ...
    public interface OnDoubleTapListener {
         ...
         * <p>
         * Unlike {@link android.view.GestureDetector.OnGestureListener#onSingleTapUp(MotionEvent)}, this
     ...
     * {@link android.view.GestureDetector.OnGestureListener}, {@link android.view.GestureDetector.OnDoubleTapListener}, and {@link android.view.GestureDetector.OnContextClickListener}
    ...
    private void init(Context context) {
        ...
        if (context == null) {
            ...
            doubleTapTouchSlop = ViewConfiguration.getTouchSlop();
